...
namespace AITalkAPI
{
    public class AITalkParameter
    {
        ...
        /// <param name="ttsParam">パラメータ</param>
        /// <param name="speakerParams">話者のパラメータリスト</param>
        internal AITalkParameter(string voiceDbName, AITalkCore.TtsParam ttsParam, AITalkCore.TtsParam.SpeakerParam[] speakerParams)
        {
            VoiceDbName = voiceDbName;
            TtsParam = ttsParam;
            SpeakerParameters = speakerParams;
